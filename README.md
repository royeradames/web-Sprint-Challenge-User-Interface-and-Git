...
blocks have width and height, and does not share it sides
inline shares it sides but it does not have width. The width is has big has the content
3. What are the 4 areas of the box model?
content, padding, border, margin
4. While using flexbox, what axis does the following property work on: ```align-items: center```?
cross axis
5. Explain why git is valuable to a team of developers.
lets a team work on a project file at the same time, and can let you go back to a previous working code from long in the past.
